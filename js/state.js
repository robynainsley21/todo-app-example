...
/**
 * (to export a typedef from a file, create a const export with the exact same name as the typedef)
...
/**
 * (author: this is the main description of the object)
...
/**
 * (author: this is the reference to the main description)
 * @type {State}
 */
export const state = {
  tasks: {},
